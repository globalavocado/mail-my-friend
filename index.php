<?php include 'inc/header.php';?>
 			...
 			<h2 class="secondary_heading">
	 			In una terra lontana, dietro le montagne Parole, lontani dalle terre di Vocalia e Consonantia, vivono i testi casuali.</h2>
			<p class="main_text">
